...
# enable auto complete for tmux sessions 
tm()
{
...
# Command prompt with git information (if available)
# bash will show the current branch when the current directory is a git repository. 
parse_git_branch() {
